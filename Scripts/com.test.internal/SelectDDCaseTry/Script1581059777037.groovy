...
for(int j=0; j<values.size();j++){
	...
	for(int i=0;i<headersCount.SIZE;i++){
		...
		String dropDownType = '//div[contains(text(),"' + rowValues.get(i) + '")]'
		TestObject dropDownelem = new TestObject('objectName')
		dropDownelem.addProperty('xpath', ConditionType.EQUALS, dropDownType)
